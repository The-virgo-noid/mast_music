...
import 'package:mast_music/model/radio.dart';
import 'package:mast_music/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "d867b9073873700104a1a72ca713d3422e956eca572e1d8b807a3e2338fdd0dc/stage",
  ...
  fetchRadios() async {
    ...
    //_selectedColor = Color(int.parse(_selectedColor));
    print(radios);
    setState(() {});
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          [
            AppBar(
              title: "Mast Music".text.xl4.bold.white.make().shimmer(
